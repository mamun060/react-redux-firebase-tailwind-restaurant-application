...
const CreateContainer = () => {
    ...
    const [calcories , setCalcories] = useState("");
    ...
    return (
        <div className=' w-full min-h-screen flex items-center justify-center'>
            <div className=' w-[90%] md:w-[75%] border border-gray-300 rounded-lg p-4 flex-col items-center justify-center gap-4'>
                {
                    fields && (
                        <motion.p 
                        initial = {{ opacity: 0 }}
                ...
                <div className=' w-full mt-4'>
                    ...
                    border-b-2 border-gray-200 p-2 rounded-md cursor-pointer' name="" id="">
                        <option value="other" className=' bg-white'> Select Category</option>
                        {
                            categories && categories.map((item, idx)=>(
                                <option key={idx} value={item.urlParamName}
